...
public class LightSubsystem extends SubsystemBase {
  ...
  public void setPreset(LightEffect.Preset pattern) {
    ...
    switch (pattern) {
      ...
      case INIT:
        ...
        break;
      case TELEOP:
        if (DriverStation.getAlliance() == Alliance.Red) {setBlink(new Color8Bit(255, 0, 0), 1800, true, 350);
  ...
  private void checkDS() {
    if (isDSConnected != DriverStation.isDSAttached()) {
      isDSConnected = DriverStation.isDSAttached();
